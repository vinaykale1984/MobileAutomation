...
public class GlobalParameters {
    ...
    public void initializeGlobalParameters(){
        ...
        switch(parameters.getPlatformName()) {
            case "Android":
                parameters.setSystemPort(Integer.parseInt(System.getProperty("systemport", String.valueOf(10000))));
                parameters.setChromeDriverPort(Integer.parseInt(System.getProperty("chromeDriverPort", String.valueOf(11000))));
                break;
            case "iOS":
